...
from aqt import QAction, QDialog, QHBoxLayout, QIcon, QMenu, Qt, qconnect
...
CHANGE_LOG = "is_change_log_2024_06_12"
...
Arthur Bookstein, Haruka, Luis Alberto, Letona Quispe, Haley Schwarz,
GP O'Byrne, Alba Grecia Suárez Recuay, Douglas Beeman, Renoaldo Costa Silva Junior,
Felipe Dias, Tobias Klös, 07951350313540, Oleksandr Pashchenko, Corentin,
Yitzhak Bar Geva, 龍星 武田, Muneeb Khan, Ansel Ng, Maik C., Ernest Chan, Ricardo Escobar,
Daniel Valcárcel Málaga, Lerner Alcala, Kurt Grabow, Daniel Kohl-Fink, Alex D, Blake, Hikori,
Ketan Pal, Natalia Ostaszewska, Gabriel Vinicio Guedes, Lily, Wa sup, Tim, Knightwalker,
as cam, Richard Fernandez, K Chuong Dang, Jason Liu, Hashem Hanaktah, Justin Skariah, Marli,
Ella Schultz, Ali Abid, Siva Garapati, Nitin Chetla, hubert tuyishime, Kyle Mondlak, J, Dan S,
Salman Majid, C, Maduka Gunasinghe, Marcin Skic, Andreas China, Lê Hoàng Phúc, anonymous
""".format(addon=SHORT_ADDON_NAME,new_feature=NEW_FEATURE)
...
def change_log_popup(*args,**kwargs):
    try:
        ...
        if (config.get(CHANGE_LOG,False) == False):

            dialog = CustomDialog(None,CHANGE_LOG_TEXT)
